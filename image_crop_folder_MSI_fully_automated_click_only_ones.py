...
try:
    os.mkdir(pwd_main + '/' + 'croped_samples')
except:
...
for pwd in folders:
    ...
    try:
        os.mkdir(pwd_main + '/' + 'croped_samples' + '/' + sub_folder_name )
    except:
        print("folder alrerady exixt 2")

    #change the cuurren working directory
    os.chdir(pwd_main + '/' + 'croped_samples' + '/' + sub_folder_name)
